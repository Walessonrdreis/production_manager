# Módulo `selected-products`

> AUTO-GENERATED: module-scaffold  
> Última atualização: `2026-05-07T19:10:51.824Z`

## 🎯 Objetivo do módulo
Descreva aqui a responsabilidade do módulo `selected-products` (domínio, integrações, limites).

...
| **🧠 [DECISIONS.md](DECISIONS.md)** | Para **entender decisões arquiteturais fundamentais** | ADR (Architectural Decisions Record) com racional, consequências e alternativas |
...
### "Preciso entender por que o sistema é assim"
1. Leia `DECISIONS.md` (Architectural Decisions Record)
2. Consulte ADRs específicos para decisões arquiteturais
3. Entenda trade-offs e alternativas consideradas
...
├── DOMAIN_NAMING_GUIDE.md    ← Guia canônico de nomenclatura de domínio

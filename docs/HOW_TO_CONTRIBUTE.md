...
> 1. **[PROJECT_MANUAL.md](./PROJECT_MANUAL.md)** - Autoridade máxima do projeto
> 2. **[DECISIONS.md](./DECISIONS.md)** - Decisões arquiteturais fundamentais (ADR)
> 3. **[ARCHITECTURE_GUIDE.md](./ARCHITECTURE_GUIDE.md)** - Arquitetura técnica detalhada
